  ...
  return (
    <Layout>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="text" placeholder="Cosot" value={precio_Shop} onChange={(e)=> setPrecio_Shop(e.target.value)}/>
      ...
      <form onSubmit={handleUpdate}>
        ...
        <input type="file" onChange={(e) => setImagen(e.target.files[0])} />
        <input type="text" placeholder="Cosot" value={precio_Shop} onChange={(e)=> setPrecio_Shop(e.target.value)}/>
        <input type="text" placeholder="ID Noticia" value={id_Shop} onChange={(e) => setIdShop(e.target.value)} />
